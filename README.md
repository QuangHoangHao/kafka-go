...
## Connection [![GoDoc](https://godoc.org/github.com/QuangHoangHao/kafka-go?status.svg)](https://godoc.org/github.com/QuangHoangHao/kafka-go#Conn)
...
## Reader [![GoDoc](https://godoc.org/github.com/QuangHoangHao/kafka-go?status.svg)](https://godoc.org/github.com/QuangHoangHao/kafka-go#Reader)
...
## Writer [![GoDoc](https://godoc.org/github.com/QuangHoangHao/kafka-go?status.svg)](https://godoc.org/github.com/QuangHoangHao/kafka-go#Writer)
...
- Creation of a missing topic before publishing a message. _Note!_ it was the default behaviour up to the version `v0.4.30`.
...
#### [Plain](https://godoc.org/github.com/QuangHoangHao/kafka-go/sasl/plain#Mechanism)
...
#### [SCRAM](https://godoc.org/github.com/QuangHoangHao/kafka-go/sasl/scram#Mechanism)
